    ...
    <div class="container-lg d-flex justify-content-md-center align-items-center vh-100 text-center">
        <div class="row">
            ...
            <div class="col">
                        ...
                        <a style="background-color:#006037;" class="btn btn-primary" href="/login" role="button">Login</a>
                        <a style="background-color:#006037;" class="btn btn-primary" href="/register" role="button">Registar</a>
            </div>
        </div>
    </div>
